  ...
  return (
    <div className=" bg-[#F48029] lg:py-12 md:py-4 xs:py-0">
      <div className="grid lg:grid-cols-5 xs:grid-cols-2  lg:py-12 xs:py-0">
        <div className=" col-span-2 mx-6 lg:pl-20 xs:pl-5  lg:py-20 xss:py-0">
        ...
        <div className="col-span-3 sm:ml-6 xs:ml-0">
          <div className="grid grid-cols-6 xs:grid-cols-1">
            ...
            <div className="text-white font-simple text-2xl md:mx-8 xs:mx-5 col-span-5">
              Our Clients
            </div>
          </div>
          <div className="pt-5  ml-5 text-white  lg:text-6xl md:text-4xl xss:text-3xl xs:text-lg font-bold lg:!leading-[80px] md:!leading-[60px] xss:!leading-[40px] xs:!leading-[30px]">
            Enduring Partnerships,
          </div>
          <div className="lg:font-medium  lg:mr-20 lg:text-6xl md:text-4xl xss:text-3xl xs:text-sm text-white ml-5 lg:pt-6 xs:pt-0 lg:!leading-[80px] md:!leading-[60px] xss:!leading-[40px] xs:!leading-[30px]">
            Building a legacy together
          </div>
          <div className="mx-5 text-white lg:text-3xl md:text-2xl lg:pb-0 md:py-8 xs:py-5 xs:pb-10">
