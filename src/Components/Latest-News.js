      ...
      <div className="pt-10">
        ...
        <div className="max-auto">
          <div className=" relative">
            ...
            <div className="p-20 gap-6 grid lg:grid-cols-3 sm:grid-cols-1 h-[700px]">
              <div className=" shadow-lg  overflow-hidden rounded bg-white">
                <img src={news1} alt=""></img>
                <h3 className="p-8 text-[23px] font-[700]">
                  5 Key Elements of Effective WordPress Web Development Services
                  in California
                </h3>
                <p className="px-8 text-[20px]">
                  In the dynamic digital landscape of California, effective web
                  development services in California are crucial for businesses
                  to establish a solid online …
                </p>
              </div>
              <div className=" shadow-lg  overflow-hidden rounded  bg-white">
                <img src={news2} alt=""></img>
                <h3 class="p-8 text-[23px] font-[700]">
                  Why is Google Analytics Essential to SEO Services in
                  California
                </h3>
                <p className="px-8 text-[20px]">
                  In the competitive online landscape, search engine
                  optimization (SEO) plays a crucial role in driving organic
                  traffic and improving the visibility of …
                </p>
              </div>
              <div className="shadow-lg  overflow-hidden rounded  bg-white">
                ...
                <p className="px-8 text-[20px]">
                  In today’s digital world, organizations must have a strong
                  online presence in order to live and succeed. Search Engine
                  Optimization (SEO) is …
                </p>
              </div>
            </div>
...
export default HamzaLatestNews;
