    ...
    <div className=" max-auto">
      ...
      <div className=" bg-[#F48029] max-w-full container lg:pb-0 xs:pb-[8rem] md:pt-[40px] xs:pt-2">
        <div className=" grid lg:grid-cols-2 md:grid-cols-1 lg:pl-14 lg:pr-28 ">
          {/* First Column */}
          <div className="md:text-left xs:text-center md:pb-20 lg:pb-28 lg:mt-4 text-white xs:mx-7 md: ">
            <h1 className="xs:text-[25px] xs:font-[800] md:text-[40px] md:font-[600] lg:font-[700] md:leading-tight xs:leading-[48px]">
              Leading E-Commerce Marketing Services in California
            </h1>
            <h1 className="my-3 xs:font-[400] md:font-normal xs:text-[16px] md:text-[20px] md:leading-9 xs:leading-[25px]">
          ...
          <div className=" overflow-hidden lg:pt-20 lg:px-0 xs:px-10">
            <img className="lg:mb-12 xs:w-full" src={img1} alt="" />
          </div>
        </div>
      </div>
      ...
      <div className="xs:px-12 lg:px-0">
        <div className="text-center lg:mx-14 bg-black rounded  text-white sm:mx-5">
          <div className="flex justify-center items-center h-full lg:px-96 md:px-60 xs:px-4">
      ...
      {/*Section 3*/}
      <div className="grid xs:grid-cols-1 md:grid-cols-3 lg:p-20 md:p-10 xs:p-10 md:gap-10 xs:gap-4">
      ...
      {/*Section 4 */}
      <div className=" xs:px-7 md:px-14 my-20 grid xs:grid-cols-1 lg:grid-cols-3 bg-gray-100">
        <div className="col-span-2 pt-40">
          <p className=" xs:text-[19px] sm:text-[28px] md:text-[45px] xs:leading-[28px] md:leading-[70px] font-[900]">
      ...
      <div>
        ...
        <p className="lg:pt-20 md:pt-10 xs:text-[28px] sm:text-[28px] md:text-[35px] font-[700] lg:mx-60 xs:mx-20 text-center">
          Why Choose Us as your E-commerce Marketing Agency in California?
        </p>
        <p className="py-12 xs:text-[14px] md:text-[20px] lg:text-[25px] xs:leading-[25px]  md:leading-[35px] text-3xl text-center lg:mx-40 xs:mx-8">
