...
class HamzaSection2 extends Component{
    render(){
        ...
        return(
            ...
            <div className="grid lg:grid-cols-2 xs:grid-cols-1 gap-4 lg:!mx-14 xs:!mx-5">
                ...
                <div>
                    <div className="grid lg:grid-cols-6 xs:grid-cols-1 md:mt-24 xs:mt-10 ">
                        <div className="lg:w-24 xs:w-14 h-0.5 my-4 lg:ml-5 lg:mr-12 bg-[#363636]"></div>
            ...
            <div style={mystyle} className="px-20">
                ...
                <p className=" lg:mt-[50px] xs:mt-4 text-center lg:text-2xl xss:text-lg xs:text-sm text-[#363636]">
