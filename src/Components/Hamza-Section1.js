    ...
    return (
      <div className="grid grid-cols-2 xs:grid-cols-1 lg:grid-cols-2 gap-4 -mt-10 mb-28 xs:-mt-20 xs:mb-10">
        ...
        <div className="lg:ml-14 xs:ml-6">
            <div className="grid lg:grid-cols-6 xs:grid-cols-2 lg:flex-none md:flex">
            ...
            <div style={mystyle} className="lg:text-4xl md:text-[40px]  xs2:text-3xl xs:text-lg font-bold text-gray-800 text-[#363636] lg:!leading-[50px] md:!leading-[60px] xss:!leading-[40px] xs:!leading-[30px]">
                Start your Product
            </div>
            <div style={mystyle} className="lg:text-4xl md:text-[40px] xs2:text-3xl xs:text-lg text-gray-800 lg:!leading-[50px] md:!leading-[60px] xss:!leading-[40px] xs:!leading-[30px]">
