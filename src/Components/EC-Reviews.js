  ...
  return (
    <div className="bg-[#FAFAFA] mt-2 pb-16 md:px-0 xs:px-7">
      ...
      <div className="grid lg:grid-cols-2 md:gird-cols-1 gap-6 lg:mx-32 md:mx-7 ">
        <div>
          {/* First Review */}
          <div className="bg-white md:text-[14px] lg:text-[18px] xs:text-[14px]  text-[#737373]  rounded-md hover:shadow-2xl xs: p-8 lg:p-8 md:p-4">
            {/* Review Text */}
            <p>
          ...
          {/* 3rd Review */}
          <div className="xs:mt-[30px] bg-[#F48029] md:text-[14px] lg:text-[18px] xs:text-[14px]  text-white  rounded-md hover:shadow-2xl p-8">
            {/* Review Text */}
            <p>
        ...
        <div className=" ">
          ...
          <div className="bg-white md:text-[14px] lg:text-[18px] xs:text-[14px]  text-[#737373]  rounded-md hover:shadow-2xl xs: p-8 lg:p-8 md:p-4">
            ...
            <div className="flex justify-start mt-6">
              <div className="w-1/20">
                {/* Content for the left column */}
                <img className="mt-4" src={rev2} alt="Reviewer 1" />
              </div>
              <div className="w-1/16 mt-5 ml-5">
                {/* Content for the right column */}
                <h1 className="ml-1 text-[#15063F] font-[500] text-[20px]">
          ...
          {/* 4th Review */}
          <div className="xs:mt-[30px] bg-[#F48029] md:text-[14px] lg:text-[18px] xs:text-[14px]  rounded-md hover:shadow-2xl p-8 text-white">
            {/* Review Text */}
            <p>
